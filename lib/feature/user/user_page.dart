...
import 'package:tpt_frontend/feature/user/widgets/user_header_widget.dart';
import 'package:tpt_frontend/feature/user/widgets/user_table_widget.dart';
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            UserHeaderWidget(controller: controller),
                            ...
                            const SizedBox(height: 8),
                            UserTableWidget(controller: controller),
                          ],
                        ),
                      ),
                    ],
