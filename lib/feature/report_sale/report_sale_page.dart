...
import 'package:tpt_frontend/feature/report_sale/widgets/report_sale_header_widget.dart';
import 'package:tpt_frontend/feature/report_sale/widgets/report_sale_table_widget.dart';
...
class SaleReportPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SaleReportController>(
      builder: (controller) {
        return SafeArea(
          child: Container(
            width: 100.w,
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            SaleReportHeaderWidget(controller: controller),
                            ...
                            const SizedBox(height: 8),
                            SaleReportTableWidget(controller: controller),
                          ],
                        ),
                      ),
                    ],
